...
namespace Flynt\Components\GridPostsLatestSlider;
...
add_filter('Flynt/addComponentData?name=GridPostsLatestSlider', function ($data) {
    $postType = POST_TYPE;
...
Options::addTranslatable('GridPostsLatestSlider', [
    [
